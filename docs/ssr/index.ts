...
const server = http.createServer(async (request, response) => {
  ...
  if (request.url === '/redoc.standalone.js') {
    ...
    const spec = yaml.load(readFileSync(resolve(__dirname, '../oas-spec.yaml'), 'utf-8'));
    ...
    <head>
      <meta charset="utf8" />
      <title>STIR/SHAKEN Authentication & Verification Service</title>
      <link rel="icon" href="https://raw.githubusercontent.com/neustar/tcs-apis/main/docs/neustar-favicon.png">
